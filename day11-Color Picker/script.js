...
inputColor.addEventListener("input", () => {
  document.querySelector(".hexcode").innerHTML = inputColor.value;
  document.querySelector("body").style.backgroundColor = inputColor.value;

  document.querySelector(".rgbcode").innerHTML = hexToRGB(inputColor.value);

  document.querySelector(".hslcode").innerHTML = hexToHSL(inputColor.value);
});
